...
* 4 - в файле GreetingContainer.tsx дописать типизацию пропсов СДЕЛАЛ
...
* 8 - в файле GreetingContainer.tsx вычислить количество добавленных и имя последнего (totalUsers, lastUserName) СДЕЛАЛ
* 9 - в файле Greeting.tsx дописать типизацию пропсов СДЕЛАЛ
